...
('10-06-2022_351110002', '2022-06-10', '351110002', 'Tidak Hadir', '2022-06-10 07:36:17'),
...
('2022-06-02_351110002', '2022-06-02', '351110002', 'Tidak Hadir', '2022-06-11 03:40:14'),
('2022-06-10_351110002', '2022-06-10', '351110002', 'Izin', '2022-06-11 03:48:01'),
('2022-06-13_351110002', '2022-06-13', '351110002', 'Hadir', '2022-06-04 15:40:33'),
('2022-06-19_351110002', '2022-06-19', '351110002', 'Hadir', '2022-06-08 16:43:44'),
...
('2022-06-25_351110002', '2022-06-25', '351110002', 'Hadir', '2022-06-04 15:52:10'),
...
THEN
SIGNAL SQLSTATE VALUE '45000' SET MESSAGE_TEXT = 'Absen tidak tersedia';
   END IF
$$
DELIMITER ;
...
--
DELIMITER $$
CREATE TRIGGER `check_duplicate_if_presensi` BEFORE INSERT ON `presensi` FOR EACH ROW IF(EXISTS(SELECT id from presensi WHERE id = new.id))
THEN
SIGNAL SQLSTATE VALUE '45000' SET MESSAGE_TEXT = 'Anda Telah melakukan presensi';
   END IF
$$
DELIMITER ;
DELIMITER $$
