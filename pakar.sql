...
--
-- Host: localhost
-- Generation Time: Jun 07, 2022 at 02:03 PM
...
THEN
SIGNAL SQLSTATE VALUE '45000' SET MESSAGE_TEXT = 'Lembur tidak tersedia, dikarenakan anda tidak presensi pada hari tersebut';
   END IF
$$
DELIMITER ;
...
('Gatau', 'Selasa', '2022-06-28', 'Gatau kok'),
